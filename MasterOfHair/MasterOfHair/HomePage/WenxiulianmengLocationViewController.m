//
//  WenxiulianmengLocationViewController.m
//  MasterOfHair
//
...
@interface WenxiulianmengLocationViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation WenxiulianmengLocationViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [userdefault setObject:[[self.arr_letterResult objectAtIndex:indexPath.section]objectAtIndex:indexPath.row] forKey:@"diquweizhi1"];
    ...
    for (loca_Model * model in self.arr_all)
    {
        ...
        {
            [userdefault setObject:model.area_id forKey:@"diquweizhi_id1"];
        }
    }
...
- (void)tapGesture:(id)sender
{
    ...
    [userdefault setObject:[userdefault objectForKey:@"city_name"] forKey:@"diquweizhi1"];
