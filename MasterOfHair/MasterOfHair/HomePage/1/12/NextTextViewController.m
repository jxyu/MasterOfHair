...
//    self.head_image.backgroundColor = [UIColor orangeColor];
    ...
    [self.head_image sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@uploads/member/%@",Url_pic,self.model.member_headpic]] placeholderImage:[UIImage imageNamed:@"touxiang"]];
...
//    self.head_name.backgroundColor = [UIColor orangeColor];
    ...
    if([self.model.member_nickname length] == 0 || [self.model.member_nickname isEqualToString:@"<null>"])
    {
        self.head_name.text = [NSString stringWithFormat:@"%@",self.model.member_username];
    }
    else
    {
        self.head_name.text = [NSString stringWithFormat:@"%@",self.model.member_nickname];
    }
...
//        self.head_time.backgroundColor = [UIColor orangeColor];
    ...
    self.head_time.text = [NSString stringWithFormat:@"%@",self.model.comment_time];
    ...
    self.head_detail.text = [NSString stringWithFormat:@"%@",self.model.comment_content];
...
- (void)p_data
{
    ...
    [dataprovider getReplyListWithComment_id:self.model.comment_id pagenumber:@"1" pagesize:@"10"];
}
...
- (void)p_data1
{
    ...
    [dataprovider getReplyListWithComment_id:self.model.comment_id pagenumber:[NSString stringWithFormat:@"%ld",(long)self.page] pagesize:@"10"];
}
#pragma mark - 数据
//掉数据
...
//    NSLog(@"%@",dict);
    ...
    if ([dict[@"status"][@"succeed"] intValue] == 1) {
        @try
        {
            ...
            NSDictionary * dict_ping = arr.firstObject;
            
            for (NSDictionary * dic in dict_ping[@"replylist"])
            {
