...
- (void)layoutSubviews
{
    ...
    self.detail.frame = CGRectMake(CGRectGetMaxX(self.image.frame), CGRectGetMaxY(self.image.frame) + 5, SCREEN_WIDTH - CGRectGetMaxX(self.image.frame) - 20, self.contentView.frame.size.height - CGRectGetMaxY(self.image.frame) - 15);
}
