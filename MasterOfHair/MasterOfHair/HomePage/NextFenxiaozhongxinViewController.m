//
//  NextFenxiaozhongxinViewController.m
//  MasterOfHair
//
...
@implementation NextFenxiaozhongxinViewController
...
- (void)p_navi
{
    _lblTitle.text = [NSString stringWithFormat:@"一级分销会员"];
...
- (void)p_dataALL
{
    ...
    [dataprovider GetFirstLevelMembersWithMember_id:[userdefault objectForKey:@"member_id"] pagenumber:@"1" pagesize:@"15"];
}
...
- (void)p_dataALL1
{
    ...
    [dataprovider GetFirstLevelMembersWithMember_id:[userdefault objectForKey:@"member_id"] pagenumber:[NSString stringWithFormat:@"%ld",(long)self.page] pagesize:@"15"];
}
