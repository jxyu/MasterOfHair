...
@interface fabudizhiViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation fabudizhiViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [userdefault setObject:[[self.arr_letterResult objectAtIndex:indexPath.section]objectAtIndex:indexPath.row] forKey:@"diquweizhi3_"];
    ...
    for (loca_Model * model in self.arr_all)
    {
        ...
        {
            [userdefault setObject:model.area_id forKey:@"diquweizhi_id3_"];
        }
    }
...
- (void)tapGesture:(id)sender
{
    ...
    [userdefault setObject:[userdefault objectForKey:@"city_id"] forKey:@"diquweizhi_id3_"];
    [userdefault setObject:[userdefault objectForKey:@"city_name"] forKey:@"diquweizhi3_"];
