...
@interface ZhaopinfenleiViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation ZhaopinfenleiViewController
...
//    view_bg.layer.borderWidth = 1;
    ...
    if(self.arr_data != 0)
    {
        ...
        {
            Zhaopingfeilei_Model * model = self.arr_data[indexPath.row - 1];
