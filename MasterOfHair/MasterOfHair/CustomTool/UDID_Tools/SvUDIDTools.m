...
static const char kKeyChainUDIDAccessGroup[] = "QFHX5W6J8N.com.sgq.titoujiang";
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    NSString *udid      = nil;
    queryErr = SecItemCopyMatching((CFDictionaryRef)dictForQuery, (void*)&udidValue);
    
    NSMutableDictionary *dict = nil;
    [dictForQuery setValue:(id)kCFBooleanTrue forKey:(id)kSecReturnAttributes];
    queryErr = SecItemCopyMatching((CFDictionaryRef)dictForQuery, (void*)&dict);
...
+ (BOOL)updateUDIDInKeyChain:(NSString*)newUDID
{
    ...
    SecItemCopyMatching((CFDictionaryRef)dictForQuery, (void*)&queryResult);
    if (queryResult) {
